...
if (!$anime_id) { header('Location: index.php'); exit(); }
...
if ($check->fetch()) {
    setFlash("⚠️ '{$anime['title']}' is already in your watchlist!", 'warning');
    header('Location: index.php'); exit();
}
...
setFlash("✅ '{$anime['title']}' added to your watchlist! Go set your status and rating.", 'success');
